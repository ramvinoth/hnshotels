...
<head>
    ...
    <title>SUBWAY ADMIN PANEL</title>
                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-User">
                                    ...
                                    <tbody>
										...
										$results = $mysqli_conn->query("SELECT * FROM login");
										//Display fetched records as you please
										while($row = $results->fetch_assoc()) {
											echo '<tr class="gradeA">';
												echo '<td>'.$row["name"].'</td>';
												echo '<td><a href="../../functions.php?id='.$row["username"].'" style="cursor:pointer;">'.$row["username"].'</a></td>';
                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-Order">
                                    ...
                                    <tbody>
										<?php
										//List products from database
										$results = $mysqli_conn->query("SELECT * FROM transaction ORDER BY order_id DESC;");
										//Display fetched records as you please
										while($row = $results->fetch_assoc()) {
											echo '<tr class="gradeA">';
												echo '<td>'.$row["date"].'</td>';
												echo '<td><a href="../../bill.php?order_id='.$row["order_id"].'" style="cursor:pointer;">'.$row["order_id"].'</a></td>';
